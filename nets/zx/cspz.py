...
class CSPDarknet(nn.Module):
    def __init__(self, dep_mul, wid_mul, depthwise=False, act="silu", use_fpn=False, use_attention=False):
        ...
        self.dark3 = nn.Sequential(
            ...
            AST(base_channels * 8, kernel_size=9, testing_flag=False) if self.use_attention else nn.Identity(),
        )
        ...
        self.dark4 = nn.Sequential(
            ...
            AST(base_channels * 16, kernel_size=7, testing_flag=False) if self.use_attention else nn.Identity(),
        )
...
if __name__ == "__main__":
    ...
    for testingNet in [net_csp_fpn_at]:
